...
//		System.out.println("sdasdasd asd asd asd asd as: >>>>>>>>>>> : ");
	...
	public ResponseEntity<Customer> updateCustomer(@PathVariable Long id,@RequestBody Customer customerDetails){
		...
		customer.setCusdob(customerDetails.getCusdob());
		customer.setCuscontactnumber(customerDetails.getCuscontactnumber());
		customer.setCusemail(customerDetails.getCusemail());
